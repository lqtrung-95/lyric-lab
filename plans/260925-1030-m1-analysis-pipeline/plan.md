...
- Model: Groq hiện không còn Llama 3.3; dùng `openai/gpt-oss-120b` (chính) và `openai/gpt-oss-20b` (dự phòng; qwen bị loại vì hạn mức đầu ra 1.000 token/phút). Thử thật trên một bài: 4–6 giây/lần, 10–12 từ + 3–5 ngữ pháp + dịch đủ mọi dòng. Validate bắt được cả hai kiểu lỗi: gpt-oss đưa ngữ pháp không khớp lời, qwen bịa từ ngoài danh sách ứng viên.
